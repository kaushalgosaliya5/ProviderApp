...
class FancyAnimatedButton1 extends StatefulWidget {
  final String? title;
  ...
  @override
  State<FancyAnimatedButton1> createState() => _FancyAnimatedButtonState();
}

class _FancyAnimatedButtonState extends State<FancyAnimatedButton1> {
  bool _show = true;
  Timer? _timer;
